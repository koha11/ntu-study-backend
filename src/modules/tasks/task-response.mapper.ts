...
export function serializeTaskForApi(task: Task): Record<string, unknown> {
  return {
    ...
    expected_outcome_type: task.expected_outcome_type ?? null,
    expected_outcome_description: task.expected_outcome_description ?? null,
    drive_folder_id: task.drive_folder_id ?? null,
